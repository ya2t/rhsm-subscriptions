...
/**
 * Configuration properties for connecting to a Cloudigrade service.
 */
public class CloudigradeApiProperties {

    private final X509ApiClientFactoryConfiguration x509Config = new X509ApiClientFactoryConfiguration();
    private boolean useStub;
    private String url;
    private String fourScaleEnv;
    ...
    public String getFourScaleEnv() {
        return fourScaleEnv;
    }

    public void setFourScaleEnv(String fourScaleEnv) {
        this.fourScaleEnv = fourScaleEnv;
    }
}
