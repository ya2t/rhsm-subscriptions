...
/**
 * A stub implementation of cloudigrade's ConcurrentApi. This API implementation will return
 * stubbed data for purpose of development.
 */
public class StubConcurrentApi extends ConcurrentApi {
    @Override
    public ConcurrencyReport listDailyConcurrentUsages(Integer limit, Integer offset) throws ApiException {
